                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row col-md-offset-1">
                                ...
                                <p class="pull-left">
                                    <h4 id="accounttype"><b><?php echo $row['accounttypedescription']?></b></h4>
                                </p>
                            </div>
                        </div>
                    </div>
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
			<div class="row">
				<ol class="breadcrumb">
					...
					<li>Manage Users</li>
					<li><a href="newAccout.php">Create User Accounts</a></li>
				</ol>
			</div><!--/.row-->
			
			<div class="row">
				<div class="col-lg-12">
					<h2 class="page-header">Create User Accounts</h2>
				</div>
			</div>
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="row">
					...
					if (isset($_POST['creation'])){
						...
						if (!isset($message)){
							...
							if (!empty($num_rows)){
								while ($row=mysqli_fetch_array($adminresult,MYSQLI_ASSOC)){
				...
				?>
					...
					<?php
						if (isset($_POST['verification'])){
								...
								if (!empty($num_rows)){
									while ($row=mysqli_fetch_array($checkresult,MYSQLI_ASSOC)){
